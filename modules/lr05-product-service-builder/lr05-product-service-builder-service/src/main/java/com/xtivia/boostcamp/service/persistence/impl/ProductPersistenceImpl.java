...
import com.xtivia.boostcamp.exception.NoSuchProductException;
import com.xtivia.boostcamp.model.Product;
import com.xtivia.boostcamp.model.impl.ProductImpl;
import com.xtivia.boostcamp.model.impl.ProductModelImpl;
 ...
 * @see com.xtivia.boostcamp.service.persistence.ProductUtil
 * @generated
 */
@ProviderType
public class ProductPersistenceImpl extends BasePersistenceImpl<Product>
	 ...
	 */
	@Override
	public Product[] findByGroupId_PrevAndNext(long id, long groupId,
		OrderByComparator<Product> orderByComparator)
		throws NoSuchProductException {
		Product product = findByPrimaryKey(id);
	 ...
	 */
	@Override
	public Product[] findByG_S_PrevAndNext(long id, long groupId, int status,
		OrderByComparator<Product> orderByComparator)
		throws NoSuchProductException {
		Product product = findByPrimaryKey(id);
	...
	protected Product toUnwrappedModel(Product product) {
		...
		productImpl.setQuantity(product.getQuantity());
		productImpl.setUnitPrice(product.getUnitPrice());
	...
	private static final String _SQL_SELECT_PRODUCT_WHERE_PKS_IN = "SELECT product FROM Product product WHERE id_ IN (";
