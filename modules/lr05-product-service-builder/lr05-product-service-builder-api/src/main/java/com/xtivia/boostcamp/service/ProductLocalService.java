...
public interface ProductLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProductLocalServiceUtil} to access the product local service. Add custom service methods to {@link com.xtivia.boostcamp.service.impl.ProductLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Product addProduct(long userId, long groupId, java.lang.String name,
		int quantity, java.lang.String unitPrice, java.lang.String desc,
	...
	*/
	...
	public List<Product> findAllByKey(java.lang.String key);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Product> getProductsByGroupId(long groupId, int start, int end)
		throws SystemException;
